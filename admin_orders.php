...
<section class="placed-orders">
   ...
   <div class="box-container">
      ...
      <div class="box"  data-aos="zoom-in-up" class="div" data-aos-duration="1000">
         <p> buyer id : <span><?php echo $row['bid']; ?></span> </p>
         ...
         <form action="" method="POST">
            ...
            <div class="flex-btn">
               ...
               <a href="admin_orders.php?delete=<?php echo $row['id']; ?>" class="delete-btn" onclick="return confirm('delete this order?');">delete</a>
            </div>
         </form>
      </div>
      <?php
