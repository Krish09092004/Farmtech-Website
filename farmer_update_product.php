...
if(isset($_POST['update_product'])){
   ...
   $sql = "UPDATE fproduct SET product ='$product', pcat='$pcat', pinfo='$pinfo', price='$price' where pid='$pid';";
...
<section class="update-product">
   ...
   ?>
   <form action="" method="post" enctype="multipart/form-data" data-aos="zoom-in-up" class="div" data-aos-duration="1000">
      <input type="hidden" name="old_image" value="<?php echo $row['pimage']; ?>">
      <input type="hidden" name="pid" value="<?php echo $row['pid']; ?>">
      <img src="uploaded_img/<?php echo $row['pimage']; ?>" alt="">
