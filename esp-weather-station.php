    ...
    <section class="content">
        ...
        <div class="box gauge--2">
            ...
            <table cellspacing="5" cellpadding="5">
                ...
                <tr>
                    <td><?php echo $min_humi['min_amount']; ?> &deg; %</td>
                    <td><?php echo $max_humi['max_amount']; ?> &deg;%</td>
                    <td><?php echo round($avg_humi['avg_amount'], 2); ?>&deg; %</td>
                </tr>
            </table>
        </div>
        <div class="box gauge--2">
            ...
            <table cellspacing="5" cellpadding="5">
                <tr>
                    <th colspan="3">Soil-moisture <?php echo $readings_count; ?> readings</th>
                </tr>
                <tr>
                    <td>Min</td>
                    <td>Max</td>
                ...
                <tr>
                    <td><?php echo $min_soilmoisture['min_amount']; ?> &deg;</td>
                    <td><?php echo $max_soilmoisture['max_amount']; ?> &deg;</td>
                    <td><?php echo round($avg_soilmoisture['avg_amount'], 2); ?>&deg; </td>
                </tr>
            </table>
        </div>
    </section>
