  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <body>
        <div class="welcome-container" data-aos="zoom-in" class="div" data-aos-duration="1000">
             ...
             <p class="p1">   Welcome to our Agriculture Hub, where farmers like you cultivate success! Explore a bountiful marketplace to showcase and sell your premium crops. Join our community dedicated to fostering growth, sharing expertise, and reaping the rewards of your hard work. Let's sow the seeds of prosperity together!
                  </p>
                  <h2><?php echo $name; ?></h2>
                  <p><?= $email ?></p>
