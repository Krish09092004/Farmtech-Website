   ...
   <form action="uploadProduct.php" method="POST" enctype="multipart/form-data">
      <div class="flex">
        ...
        <input type="text" name="product" class="box" required placeholder="enter product name">
         ...
         <div class="inputBox">
         <input type="text"  name="price" class="box" required placeholder="enter product price with weight">
         <input type="file" name="productPic" required class="box" accept="image/jpg, image/jpeg, image/png">
         </div>
      </div>
      <textarea name="pinfo" class="box" required placeholder="enter product details" cols="30" rows="10"></textarea>
...
<section class="show-products">
   ...
   <div class="box">
      ...
      <div class="flex-btn">
         ...
         <a href="farmer_update_product.php?update=<?php echo $row['pid']; ?>" class="option-btn">update</a>
         <a href="uploadProduct.php?delete=<?php echo $row['pid']; ?>" class="delete-btn" onclick="return confirm('delete this product?');">delete</a>
      </div>
   </div>
   <?php
      }
