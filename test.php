...
<html>
	...
	<title>Signup & Register page</title>
...
<main>
      <div class="box animate">
		...
		<form method='POST' action="Login/login.php" class="sign-in-form" autocomplete="off">
			...
			<b>Category : </b>
			<div class='py'>
    <input type="radio" class="option-input radio" id="farmer" name="category" value="1" checked />
    <b>Farmer</b>
	<br>
	...
	<form method='POST' action="Login/signUp.php" autocomplete="off" class="sign-up-form" onsubmit="return matchpass()">
	...
	<div class="actual-form">
			<input type="text" name="name" id="name"   minlength="4" autocomplete="off" value="" placeholder="Name" required/>
			<input type="text" name="uname" id="uname" value="" placeholder="User-Name" required/>
			<input type="number" maxlength="10" name="mobile" min="0000000000" minlength="10" autocomplete="off" min="1" max="9999999999" oninput="maxLengthCheck(this)" id="mobile" value="" placeholder="Mobile number" required/>
			<input type="email" name="email" id="email" value="" autocomplete="off" placeholder="Email" required/>
			<div class="input-box">
			<input type="password" name="password" id="password"  value="" placeholder="Password" required/>
			<p id="message" class="ins-2">Password is <span id="strength"></span></p>
</div>
			<input type="password" name="pass" id="pass" value="" placeholder="Confirm Password" required/>
